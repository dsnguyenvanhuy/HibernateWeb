...
<head>
    ...
    <!-- Font Awesome Icon -->
    <link type="text/css" rel="stylesheet" href="<c:url value='/template/web/css/font-awesome.min.css'/>"/>
...
<body>
<!-- HEADER -->
<c:import url="/common/web/header.jsp"/>
<!-- /HEADER -->
...
<!-- FOOTER -->
<c:import url="/common/web/footer.jsp"/>
<!-- /FOOTER -->
